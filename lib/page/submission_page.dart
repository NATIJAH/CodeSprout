...
class _SubmissionPageState extends State<SubmissionPage> {
        ...
        return Card(
          ...
          child: ListTile(
            leading: Icon(
              ...
              color: submission['graded'] == true ? AppColor.success : Colors.amber,
              size: 32,
            ),
            title: Text(
            ...
            subtitle: Column(
              ...
              children: [
                ...
                if (submission['graded'] == true)
                  Text('✓ Graded', style: TextStyle(color: AppColor.success, fontWeight: FontWeight.bold)),
              ],
            ),
            trailing: Row(
              ...
              children: [
                IconButton(
                  icon: Icon(Icons.download, color: AppColor.primaryGreen),
  ...
  Widget _buildTab(int index, String title, IconData icon) {
    ...
    return Expanded(
      child: Material(
        color: isSelected ? AppColor.primaryGreen.withOpacity(0.2) : Colors.transparent,
        child: InkWell(
          ...
          child: Container(
            ...
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                Icon(icon, color: isSelected ? AppColor.primaryGreen : AppColor.textLight),
                SizedBox(height: 4),
                Text(
                  title,
                  style: TextStyle(
                    color: isSelected ? AppColor.primaryGreen : AppColor.textLight,
