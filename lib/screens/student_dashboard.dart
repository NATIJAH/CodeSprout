...
class _StudentDashboardState extends State<StudentDashboard> {
  ...
  // Sample task dates for calendar - replace with real data from Supabase
  final Map<DateTime, List<String>> _taskDates = {
    DateTime.utc(2024, 12, 25): ['Tugasan Matematik', 'Quiz Sains'],
    DateTime.utc(2024, 12, 28): ['Latihan BM'],
    DateTime.utc(2025, 1, 2): ['Projek Sejarah'],
  };
  ...
  List<String> _getTasksForDay(DateTime day) {
    return _taskDates[DateTime.utc(day.year, day.month, day.day)] ?? [];
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xfff4f6f0), // Soft matcha cream background
      appBar: AppBar(
        elevation: 0,
        title: Row(
          children: [
        ...
        backgroundColor: const Color(0xfffdfefb), // Warm white
          ...
          Padding(
            ...
            child: GestureDetector(
              ...
              child: const CircleAvatar(
                radius: 18,
                backgroundColor: Color(0xff8fad91), // Soft matcha green
      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: [
            ...
            _drawerTile(Icons.picture_as_pdf, "Latihan", StudentExercise()),
          ...
          return SingleChildScrollView(
            ...
            child: isWideScreen
              ...
              children: [
                ...
                SizedBox(
                  width: 350,
                  child: _buildUpcomingEvents(), // NEW: Ganti calendar widget lama
                ),
              ],
            )
                : Column(
  ...
  // ============= NEW: Upcoming Events Widget (ganti calendar widget lama) =============
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 4),
                        Text(
                          'Event dari guru akan dipaparkan di sini',
                          style: TextStyle(
                            fontSize: 12,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [Color(0xff8fad91), Color(0xffa8c5aa)], // Matcha gradient
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
        borderRadius: BorderRadius.circular(16),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildProgressBar("Tugasan Selesai", 0.75, const Color(0xff8fad91)),
          const SizedBox(height: 12),
          _buildProgressBar("Latihan Selesai", 0.60, const Color(0xffa8c5aa)),
          const SizedBox(height: 12),
          _buildProgressBar("Kehadiran", 0.90, const Color(0xffd4a574)),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Divider(height: 24, color: Color(0xfff4f6f0)),
          _buildActivityItem(
            "Latihan Sains",
            "Dec 19, 1:20 PM",
            "Dalam progress",
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _buildLegendItem("Tugasan", "50%", const Color(0xff8fad91)),
                      const SizedBox(height: 12),
                      _buildLegendItem("Latihan", "30%", const Color(0xffd4a574)),
                      const SizedBox(height: 12),
                      _buildLegendItem("Aktiviti", "20%", const Color(0xffa8c5aa)),
                    ],
                  ),
                ),
              ],
...
// ============= NEW: Student Notification Dropdown (tema student) =============
...
// ============= NEW: Student Calendar Dropdown (tema student) =============
...
// ============= Student Add Event Dialog (simpler version - personal only) =============
...
class _StudentAddEventDialogState extends State<_StudentAddEventDialog> {
  ...
  String _selectedColor = '#8fad91'; // Student theme color
  ...
  Future<void> _saveEvent() async {
    ...
    final event = await widget.calendarService.createEvent(
      ...
      eventType: 'personal', // Student hanya boleh buat personal event
    );
