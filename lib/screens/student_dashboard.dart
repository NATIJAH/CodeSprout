      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: [
            ...
            _drawerTile(Icons.menu_book, "Bahan-bahan Pengajaran", context, const StudentTeachingMaterial()),
            _drawerTile(Icons.picture_as_pdf, "PDF", context, const StudentPdf()),
            _drawerTile(Icons.help, "MCQ", context, const StudentMcq()),
            _drawerTile(Icons.chat, "Berbual", context, const OpenStudentChat()),
