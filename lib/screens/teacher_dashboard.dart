...
import 'teacher_support_page.dart'; // NEW
      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: [
            ...
            _drawerTile(
                Icons.menu_book, "Bahan-bahan Pengajaran", context, const TeacherTeachingMaterial()),
            _drawerTile(Icons.picture_as_pdf, "Latihan", context, TeacherExercise()),
            _drawerTile(Icons.chat, "Berbual", context, const OpenTeacherChat()),
            _drawerTile(Icons.event, "Aktiviti", context, const ActivityHub()),
            _drawerTile(Icons.settings, "Tetapan", context, const TeacherMcq()),
            _drawerTile(Icons.support_agent, "Support", context, const TeacherSupportPage()), // NEW
            const Divider(),
            ListTile(
