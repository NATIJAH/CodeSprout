...
class AccountViewTeacher extends StatefulWidget {
  const AccountViewTeacher({super.key});

  @override
  State<AccountViewTeacher> createState() => _AccountViewTeacherState();
}

class _AccountViewTeacherState extends State<AccountViewTeacher> {
  ...
  Future<void> fetchAccountData() async {
    ...
    try {
      ...
      // Fetch from profile_teacher table to get name, phone, and image
  ...
  Future<void> deleteAccount() async {
    try {
      ...
      await supabase.from('profile_teacher').delete().eq('id', user.id);
