import 'package:codesprout/screens/student_exercise.dart';
            ...
            children: [
              Container(
                ...
                child: Icon(
                  ...
                  color: hasAttempt ? StudentColors.success : StudentColors.primaryGreen,
                  size: 32,
                ),
              ),
              SizedBox(width: 16),
...
class _McqPracticePageState extends State<McqPracticePage> {
  ...
  void _goBackToMcqPage() {
    ...
    Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(
        builder: (context) => StudentExercise(initialTabIndex: 1),
      ),
      (route) => false,
    );
  }
                      ...
                      TextButton(
                        onPressed: () {
                          Navigator.pushAndRemoveUntil(
                            context,
                            MaterialPageRoute(
                              builder: (context) => StudentExercise(),
                            ),
                            (route) => false,
                          );
                        },
